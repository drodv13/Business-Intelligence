...
def load_data() -> pd.DataFrame:
    ...
    if not files:
        st.error(
            "No se encontraron archivos `data/datamart_accidentes_*.parquet`. "
...
st.caption("Datos exportados desde proyecto_destino a archivos Parquet divididos para despliegue en Streamlit Cloud.")
